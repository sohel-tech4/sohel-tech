        ...
        <div
            ...
            <div
                ...
                <div className='text-2xl mt-5 mb-5 md:text-left text-center'>
                    ...
                    <button className='mr-5 border p-2 rounded-full hover:text-green-600 hover:border-green-600'><Link to="https://www.linkedin.com/in/soheltech" target='_blank'><FaGithub /></Link></button>
